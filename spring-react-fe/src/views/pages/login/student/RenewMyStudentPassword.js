...
//
export default class RenewMyStudentPassword extends Component {
    constructor(props) {
        super(props);
    ...
    renewMyNewPassword() {
        ...
        AuthService.resetMyStudentPassword(
            ...
            (response) => {
                // console.log('secure My Password ----HIHIHI--------- 2: ' + this.state.retypeNewPassword);
