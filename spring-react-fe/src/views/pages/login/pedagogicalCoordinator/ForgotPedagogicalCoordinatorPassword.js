...
const steps = [
    {
        ...
        content: () => (
            <Text>
                ...
                <span className="pinkAlertBold">Chef(fe) de Département ou Coordinateur(trice) Pédagogique</span>&nbsp;
    ...
    },
    {
        ...
        content: () => (
            <Text>
                En tant que&nbsp;
                <span className="pinkAlertBold">Chef de Département / CPS</span>&nbsp;:
                <br/><br/>
    ...
    },
    {
        ...
        content: () => (
            <Text>
                ...
                <a href="https://pfe.esprit.tn/pedagogicalCoordinator" target="_blank" rel="linkFP" style={{color:'blue'}}>Mot de passe connu !</a>
            </Text>
        )
    },
    {
...
export default class ForgotPedagogicalCoordinatorPassword extends Component
{
    constructor(props)
    {
        super(props);
    ...
    handleLogin(e)
    {
        ...
        if (this.checkBtn.context._errors.length === 0)
        {
            ...
            AuthService.applyToInitializeMyCDCPSPassword(this.state.username).then(
                response =>
                {
                    ...
                    //this.props.history.push("/renewpedagogicalCoordinatorPassword");
                                        ...
                                        <CCardBody>
                                            ...
                                            <span className="greenAlert">
                                                ...
                                                Vous êtes invité(e)s à consulter votre boite Mail pour initialiser votre Mot de Passe.
                                                                            ...
                                                                            <br />
                                                                            <br />
                                                                            <Link to={"/renewMyPedagogicalCoordinatorPassword"}>
                                                                                <button
                                    ...
                                    <CCard className="text-white bg-light py-4">
                                        <CCardBody className="text-center">
                                            <div>
                                                ...
                                                <br/>
                                                <p className="userSpace">Espace Chef(fe) de Département -</p>
                                                <p className="userSpace">Espace Coordinateur(trice) Pédagogique</p>
