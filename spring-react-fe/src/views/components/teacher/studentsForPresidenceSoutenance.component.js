...
export default class StudentsForMPresidenceSoutenance extends Component {
    constructor(props) {
        super(props);
    ...
    loadStudentsAffectedToExpertByDefaultYear() {
        AcademicEncadrantService.studentsByJuryPresidenceForSTN(currentTeacher.id, this.state.selectedYear).then(
            (response) => {
    ...
    loadStudentsAffectedToExpert = (selectedYearObject) => {
        ...
        AcademicEncadrantService.studentsByJuryPresidenceForSTN(currentTeacher.id, selectedYearObject.label).then(
            (response) => {
                                                                ...
                                                                <CRow>
                                                                    <CCol md="11">
                                                                        <center>
                                                                            ...
                                                                            <br/><br/>
                                                                            <span className="greyMarkCourrier">Désolé, Vous n'êtes pas un(e) Président(e) Jury d'aucune soutenance pour cette Session.</span>
                                                                            <br/><br/><br/><br/>
                                                                        </center>
                                                                    </CCol>
                                                                    <CCol md="1"/>
