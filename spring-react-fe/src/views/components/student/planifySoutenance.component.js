...
export default class PlanifySoutenance extends Component {
  ...
  */
  ...
  loadStudentsAuthorizedTOSTN() {
    AuthService.studentsAllAuthorizedToSTN(currentResponsableServiceStage.id).then(
        (response) => {
  ...
  handleDownloadFicheDepotPFE(identifiant, fullName, classe) {
    ...
    AuthService.downloadFicheDepotPFE(identifiant, fullName, classe).then(
        (response) => {
    ...
    if (bpvd.fullName !== undefined) {
      AuthService.downloadFicheDepotPFE(identifiant, bpvd.fullName, bpvd.currentClass).then(
          (response) => {
            // console.log("Check Disponibility --------cr----- 4");
  ...
  handleDownloadAllPlanningSoutenanceExcel() {
    ...
    AuthService.downloadPlanningSoutenanceExcel(1, currentResponsableServiceStage.id).then(
        (response) => {
          this.setState({showLoadingExcelGreenIcon: false})
          let filename = "Planning Soutenances Non Planifiées.xls";
  ...
  validateAndNotifyUniquePlanif() {
    ...
    AuthService.validateAndNotifySoutenanceActors(
        ...
        (response) => {
          ...
          requestBin.open("GET", API_URL_MESP + "itsGCWithPair/" + idEt, false);
          requestBin.send(null);
          let itsGC = requestBin.responseText;

          let idPairGC = "";
          if (itsGC.includes('YES')) {
            idPairGC = itsGC.substring(3);
            // console.log('---------------itsgc---------> HI 123: ' + itsGC + ' - ' + idPairGC);
            this.setState({
              listOfAuthorizedStudentsToSTN: this.state.listOfAuthorizedStudentsToSTN.filter(el => el.identifiant != idPairGC),
  ...
  checkDisponibilityEncadrantForAP() {
    ...
    AuthService.checkDisponibilityEncadrantForAP(
        ...
        (response) => {
          ...
          requestCRs.open("GET", API_URL_MESP + "/disponibilityClassrooms" + "/" + idsOfCheckedStudentsForAPSTN
              + "/" + this.gotFormattedDate(this.state.selectedDateAP)
              + "/" + this.state.selectedStartHourAP
  ...
  handleAutoPlanifSallesExpertsJuryPresidentsForAP() {
    ...
    // console.log('----------------------> SARS 1: ' + this.state.listOfCheckedStudentsForAPSTN.length);

    // console.log('----------------------> SARS 1.1: ', this.state.listOfCheckedStudentsForAPSTN);
    this.setState({
    ...
    //for (let idStu of this.state.checkedStudents) {
    for (let stu of this.state.listOfCheckedStudentsForAPSTN) {
      idsOfCheckedStudentsForAPSTN.push(stu.identifiant);
    }

    // console.log('----------------------> SARS 2: ' + this.state.listOfCheckedStudentsForAPSTN.length);
    ...
    AuthService.handleAutoPlanifSallesExpertsJuryPresidentsForAP(
        ...
        .then(() => {
          ...
          this.state.allTeachersMembreMP = [];
          this.state.allTeachersJuryPresMP = [];
          ...
          for (let tea of strIntoObjTea) {
            ...
            result.map((item, index) => {
              this.state.allTeachersMembreMP.push({value: item[0], label: item[1]});
              this.state.allTeachersJuryPresMP.push({value: item[0], label: item[1]});
            });
          }
          ...
          // this.state.checkedStudents
          AuthService.checkedStudentsToMultiplePlanifSTN(currentResponsableServiceStage.id, idsOfCheckedStudentsForAPSTN).then(
              (response) => {
...
// DONT
                  /********************************************** Case GC-Binome START ************************************************/
                  let requestBin = new XMLHttpRequest();
                  requestBin.open("GET", API_URL_MESP + "itsGCWithPair/" + stu.identifiant, false);
                  requestBin.send(null);
                  let itsGC = requestBin.responseText;
  ...
  gotStudentSTNAffectationDetailsPlanify(idEt) {
    ...
    console.log("--------------AZE-----0906---->RES-1: ", resultDPEPL);
    /*
...
*/
  ...
  onChangeSelectExpertMP(studentId, selectedExpertId) {
    AuthService.affectExpertMP(studentId, selectedExpertId).then(
        (response) => {
          ...
          console.log('- AM 1m - Membre ------------- 0906 ---> ', this.state.allTeachersMembreMP.length);
          console.log('- AM 1m - Jury P ------------- 0906 ---> ', this.state.allTeachersJuryPresMP.length);

          this.setState({
            allTeachersJuryPresMP: this.state.allTeachersJuryPresMP.filter(el => el.value != selectedExpertId)
          })

          console.log('- AM 2m - Membre ----------------------- 0906 ---> ', this.state.allTeachersMembreMP.length);
          console.log('- AM 2m - Jury P ----------------------- 0906 ---> ', this.state.allTeachersJuryPresMP.length);
  ...
  onChangeSelectJuryPresidentMP(studentId, selectedJuryPresidentOption) {
    AuthService.affectJuryPresidentMP(studentId, selectedJuryPresidentOption).then(
        (response) => {
          ...
          console.log('- AJ 1m - Membre ------------- 0906 ---> ', this.state.allTeachersMembreMP.length);
          console.log('- AJ 1m - Jury P ------------- 0906 ---> ', this.state.allTeachersJuryPresMP.length);

          this.setState({
            allTeachersMembreMP: this.state.allTeachersMembreMP.filter(el => el.value != selectedJuryPresidentOption)
          })

          console.log('- AJ 2m - Membre ----------------------- 0906 ---> ', this.state.allTeachersMembreMP.length);
          console.log('- AJ 2m - Jury P ----------------------- 0906 ---> ', this.state.allTeachersJuryPresMP.length);
  ...
  handleOpenModalPlanificationMultiple() {
    ...
    // console.log('############################# Size EXP-MP: ' + this.state.allTeachersMembreMP.length)
  ...
  handleOpenModalPlanificationAdvanced() {
    this.setState({
      listOfCheckedStudentsForAPSTN: [],
      loadAdvancedPlanification: true,
      disableCheckDispoPE: false,
      alertNbrSallesToChoose: 0,
      showFullPlanningForAP: false,
      disableValidateAutoPlanifBTN: false,
                  ...
                  <>
                    <CRow>
                      <CCol>
                        ...
                        <span style={{color: "#cc0000", fontSize: "14px", fontWeight: "bold"}}>
                          Liste des Étudiants avec Dépôts Validés - ({listOfAuthorizedStudentsToSTNByFilter.length}/{listOfAuthorizedStudentsToSTN.length})
                        </span><br/><br/>
                                </CCol>
                                  ...
                                  <CRow>
                                    {(
                                        ...
                                        <CButton shape="pill"
                                          ...
                                          <CTooltip content="Télécharger Planning Soutenance suivant Filtre"
                                                    placement="top">
                                            <img src={excelBlueIcon} className="cursorPointer"
                                  ...
                                  <CRow>
                                    {(
                                        ...
                                        <CButton shape="pill"
                                          ...
                                          <CTooltip content="Télécharger Planning Soutenances" placement="top">
                              ...
                              <CRow>
                                ...
                                &nbsp;
                                <span style={{color: "#ff1a75", fontSize: "12px", marginTop: "11px"}}>
                                  Select / Deselect All
                                </span>

                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                {(
                                    checkedStudents.length > 0 && !loadAdvancedPlanification &&
                                    <Button style={{color: "#ff00bf", fontSize: "12px"}}
                                            onClick={() => this.handleOpenModalPlanificationAdvanced()}>
                                      <CIcon content={freeSet.cilCalendarCheck}/> &nbsp; Planification Avancée
                                    </Button>
                                )}
                                ...
                                {(
                                    ...
                                    <Button style={{color: "#ff00bf", fontSize: "12px"}}
                                      ...
                                      <CIcon content={freeSet.cilCalendarCheck}/> &nbsp; Planification Personnalisée
                                    </Button>
                                )}
                            ...
                            <CDataTable
                                ...
                                scopedSlots={{
                                      ...
                                      <td>
                                        <center>
                                          <CButton shape="pill"
                                            ...
                                            <CTooltip content="Consulter Contacts Étudiant" placement="top">
                                          ...
                                          <CButton shape="pill"
                                            ...
                                            <CTooltip content="Planifier Soutenance" placement="top">
                                          ...
                                          <CButton shape="pill"
                                                   ...
                                                   size="sm"
                                                   aria-expanded="true"
                                                   onClick={() => this.handleOpenPopupArchiveSoutenance(item.identifiant, item.fullName)}>
                                            <CTooltip content="Archiver Soutenance" placement="top">
                                              <CIcon content={freeSet.cilTags}/>
                                            </CTooltip>
                                          </CButton></center>
                                      </td>
                                  ),
                                  checkboxSelect: (item) => (
                                      <td>
                                        <center>
                                          <Checkbox checked={this.state.checked[item.identifiant] === true}
                                                    color="secondary"
                            ...
                            <CTabContent>
                                  ...
                                  {loadingListOfAvExpsToSTN && (
                                      <center>
                                        ...
                                        <span style={{
                                          color: "#cc0000",
                                          fontSize: "13px"
                                        }}>Merci de Patienter un Peu ...</span>
                                        <br/>
                                            ...
                                            action: (item, index) => (
                                                <tr key={index}>
                                                  <td>
                                                    ...
                                                    >
                                                      <CTooltip content="Affecter Membre" placement="top">
                                                        <CIcon content={freeSet.cilUserFollow}/>
                                                      </CTooltip>
                                                    </CButton>
                                                  </td>
                                                </tr>
                                                      ...
                                                      action: (item, index) => (
                                                          <tr key={index}>
                                                            <td>
                                                              ...
                                                              >
                                                                <CTooltip content="Affecter Président Jury"
                                                                          placement="top">
                                                                  <CIcon content={freeSet.cilUserFollow}/>
                                                                </CTooltip>
                                                              </CButton>
                              ...
                              <CTabPane>
                                <div>
                                  ...
                                  <CRow>
                                    <CCol md="8">
                                      Cet Étudiant passe sont PFE <span className="text-info">{traineeKind}</span>
                                      <br/><br/>
                                            ...
                                            action: (item, index) => (
                                                <tr key={index}>
                                                  <td>
                                                    ...
                                                    >
                                                      <CTooltip content="Affecter Salle" placement="top">
                                                        <CIcon content={freeSet.cilRoom}/>
                                                      </CTooltip>
                                                    </CButton>
                                                  </td>
                                                </tr>
                              ...
                              <CTabPane>
                                    ...
                                    <div>
                                      ...
                                      {(
                                          ...
                                          <>
                                            ...
                                            <span className="text-info"> {selectedStudentFullName} </span>
                                          </>
                                      )}
                                      ...
                                      a été effectuée le <span className="text-info"> {formattedSelectedDate} </span>
                                      ...
                                      {(
                                          ...
                                          <>
                                            ...
                                            dans la salle <span className="text-info"> {salle} </span>.
                                          </>
                                      )}
                                      {(
                                          salle === "Remote" &&
                                      ...
                                      <br/><br/>
                                      Cliquer sur ce bouton pour confirmer cet état et notifier l'Étudiant, l'Encadrant
                                      Pédagogique, le Membre et le Président de Jury de la date programmée.
                                      <br/><br/>
                                      ...
                                      {(
                                          ...
                                          <Button variant="outlined"
                                                  color="primary"
                                                  onClick={this.validateUniquePlanif}
                                                  disabled={loadingValidateUniquePlanif}>
                                ...
                                {((affectedEXP.identifiant === undefined || !affectationPresidentJury === 'DONE' || salle === "") &&
                                    <div>
                                      ...
                                      <span className="text-danger"> n'est pas encore achevée</span>.
                                    </div>
                                )}
                                ...
                                {(
                                    ...
                                    <div>
                                      ...
                                      les Notifications aux membres de jury <span className="text-success"> sont envoyées</span>.
                                    </div>
                                )}
                        ...
                        <CRow>
                          ...
                          <CCol xs="7">
                            {(
                                ...
                                <div>
                                  {affectedJP.nom} <span className="note">(Affectation Interne)</span>
                                </div>
                            )}
                            {(
                                presidentJuryNotEns !== "" &&
                                <div>
                                  {presidentJuryNotEns} <span className="note">(Affectation Externe)</span>
                                </div>
                            )}
                          </CCol>
                        </CRow>
                    ...
                    <Dialog fullHight
                      ...
                      <DialogContent>
                        <br/>
                        <center>
                          Êtes-vous sûr de vouloir archiver la Soutenance de &nbsp;&nbsp;
                      ...
                      <DialogActions>
                        <CButton onClick={this.handleTurnSoutenanceToPlanified} variant="outline" color="success">
                          Oui
                        </CButton>
                        &nbsp;
                        <CButton onClick={this.handleClosePopupArchiveSoutenance} variant="outline" color="danger">
                          Non
                        </CButton>
                      </DialogActions>
                    </Dialog>
                                        ...
                                        scopedSlots={{
                                          membre: (item) => (
                                              <td>
                                                <CRow>
                                                  <CCol xs="2">
                                                    <Badge badgeContent={item.nbrStuTrainedByMembre} showZero
                                                  ...
                                                  <CCol xs="10">
                                                    <Select key={item.membre}
                                                            defaultValue={{value: item.membre, label: item.membre}}
                                                            closeMenuOnSelect={true}
                                                            value={this.state.allTeachersMembreMP.value}
                                                            components={animatedComponents}
                                                            options={this.state.allTeachersMembreMP}
                                                            size="sm"
                                          ...
                                          juryPresident: (item) => (
                                              <td>
                                                <CRow>
                                                  <CCol xs="2">
                                                    <Badge badgeContent={item.nbrStuTrainedByJuryPresident} showZero
                                                           color="error" style={{marginTop: "12px"}}>
                                                      <PersonIcon/>
                                                    </Badge>
                                                  </CCol>
                                                  <CCol xs="10">
                                                    <Select key={item.juryPresident}
                                                            ...
                                                            closeMenuOnSelect={true}
                                                            value={this.state.allTeachersJuryPresMP.value}
                                                            components={animatedComponents}
                                                            options={this.state.allTeachersJuryPresMP}
                        ...
                        <CRow>
                          <CCol xs="12">
                            <center>
                              ...
                              les {listOfCheckedStudentsForMPSTN.length} étudiants sélectionnés sont effectuées.
                            </center>
                          </CCol>
                        </CRow>
                      </DialogContent>
                              ...
                              <CCol xs="12">
                                <center>
                                  ...
                                  <span className="text-danger" style={{fontSize: "15px"}}>
                                                                        Les Encadrants Pédagogiques des Étudiants Sélectionés ne sont pas disponibles pour ce créneau horaire.
                                                                        <br/>
                            ...
                            <CRow>
                              <CCol xs="12">
                                <center>
                                  ...
                                  <br/><br/>
                                  <span
                                      style={{color: "#cc0000", fontSize: "13px"}}>Merci de Patienter un Peu ...</span>
                                  <br/>
                                  <span style={{color: "#cc0000", fontSize: "13px"}}>Validation de la Disponibilité des Encadrants Académiques En Cours.</span>
                                  <br/><br/>
                                </center>
                              </CCol>
                            </CRow>
                              ...
                              <CCol xs="12">
                                <center>
                                  ...
                                  <span
                                      style={{color: "#cc0000", fontSize: "13px"}}>Merci de Patienter un Peu ...</span>
                                  <br/>
                                  <span style={{color: "#cc0000", fontSize: "13px"}}>Validation de l'Auto-Planification En Cours.</span>
                                  <br/><br/>
                                </center>
                              </CCol>
                            </CRow>
                              ...
                              <CCol xs="12">
                                <center>
                                  ...
                                  <span
                                      style={{color: "#cc0000", fontSize: "13px"}}>Merci de Patienter un Peu ...</span>
                                  <br/>
                                  <span style={{color: "#cc0000", fontSize: "13px"}}>Envoi des Notifications aux Étudiants et Membres des Jury En Cours.</span>
                                  <br/><br/>
                                </center>
                              </CCol>
                            </CRow>
