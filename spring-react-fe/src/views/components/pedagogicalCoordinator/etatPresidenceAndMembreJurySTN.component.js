...
export default class EtatPresidenceAndMembreJurySTN extends Component {
  constructor(props) {
    super(props);
  ...
  loadAcademicEncadrants()
  {
    ...
    PedagogicalCoordinatorService.findAllTeachersForPresidenceAndMembreByYear(this.state.selectedYear).then(
        (response) => {
  ...
  handleDownloadEncadrementStatus()
  {
    ...
    ResponsableServiceStageService.downloadAPresidenceAndMembrejuryForSTNStatusByYear(this.state.selectedYear).then(
        (response) => {
  ...
  */
    ...
    PedagogicalCoordinatorService.findAllTeachersForPresidenceAndMembreByYear(selectedCompOption.label).then(
        (response) => {
          this.setState({
            academicEncadrants: []
          });
