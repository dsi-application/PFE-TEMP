...
//
export default class SecurePedagogicalCoordinatorPassword extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      redirect: null,
      currentPedagogicalCoordinator: { id: "", password: "" },
      newPassword: "",
      retypeNewPassword: "",
      successSecurePedagogicalCoordinatorPassword: false,
  ...
  componentDidMount() {
    ...
    // console.log('---------------> 1: ' + currentPedagogicalCoordinator.id + " - " + currentPedagogicalCoordinator.password);



    // console.log('---------------> 2: ' + currentPedagogicalCoordinator.id);
  ...
  secureMyNewPassword()
  {
    ...
    AuthService.securePedagogicalCoordinatorPassword(
      ...
      (response) => {
        ...
        this.setState({
          successSecurePedagogicalCoordinatorPassword: true,
          loadSecureMdp: false
        });
      },
      (error) => {
      ...
      <>
        ...
        <CRow>
          ...
          <CCol md="10">
            ...
            <CRow>
              ...
              <CCol md="4">
                <input
                  ...
                  name="newPassword"
                  value={currentPedagogicalCoordinator.password}/>
              </CCol>
            </CRow>
                ...
                <div className="float-right">
                  {
                    ...
                    <button  type="button"
                             ...
                             disabled={(!passwordsDontMatchErrorMsg.includes("Ok") && !requiredPasswordLength.includes("Confirmed")) ||
                             (!passwordsDontMatchErrorMsg.includes("Ok") && requiredPasswordLength.includes("Confirmed")) ||
                             (passwordsDontMatchErrorMsg.includes("Ok") && !requiredPasswordLength.includes("Confirmed"))}
                             onClick={() => {this.secureMyNewPassword()}}>
            ...
            {this.state.successSecurePedagogicalCoordinatorPassword && (
              <Modal
                isOpen={this.state.successSecurePedagogicalCoordinatorPassword}
