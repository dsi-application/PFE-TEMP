...
@Embeddable
public class SaisonClasseCSPK implements Serializable{
	...
	public SaisonClasseCSPK(String codeCl, String anneeDeb, String semester) {
		super();
		this.codeCl = codeCl;
		this.anneeDeb = anneeDeb;
		this.semester = semester;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SaisonClasseCSPK other = (SaisonClasseCSPK) obj;
		if (anneeDeb == null) {
