...
public class PlanningSoutenanceGlobal_Excel
{
    ...
    public PlanningSoutenanceGlobal_Excel(List<StudentSTNExcelDto> studentsDtos, String sessionLabel, String PSFile)
	{
		try
		{
			...
			cell.setCellValue(" Planning Soutenances - Session " + sessionLabel);
			...
			/*
			 stu.getIdEt(), stu.getNomet(), stu.getPrenomet(), 
						stu.getAdressemailesp(), stu.getTelet(), currentClass, dateDepot, dateSoutenance, 
						heureSoutenance, salle, juryPresident,
						pedagogicalEncadrant, mailPedagogicalEncadrant, expert, mailExpert 
			 */
