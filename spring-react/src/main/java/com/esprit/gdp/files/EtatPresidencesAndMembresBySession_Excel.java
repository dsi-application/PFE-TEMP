...
public class EtatPresidencesAndMembresBySession_Excel
{
    ...
    public EtatPresidencesAndMembresBySession_Excel(String selectedSession, List<TeacherQuotaPresidenceMembreDto> ess, String PSFile)
	{
		try
		{
			HSSFWorkbook workbook = new HSSFWorkbook();
			HSSFSheet sheet = workbook.createSheet("Session " + selectedSession);
			...
			cell.setCellValue("État Présidences & Membres\r\n" + selectedSession);
