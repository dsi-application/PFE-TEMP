...
public class EtatEncadrementsAndExpertisesByYear_Excel
{
    ...
    public EtatEncadrementsAndExpertisesByYear_Excel(String selectedYear, List<TeacherQuotaEncadrementExpertiseDto> ess, String PSFile)
	{
		try
		{
			...
			cell.setCellValue("État Encadrements & Expertises\r\n" + selectedYear + " - " + (Integer.parseInt(selectedYear) + 1));
...
//			cellColumnTitle.setCellValue("Détails Encadrant Académique");cellColumnTitle.setCellStyle(columnTitleStyle);
			...
			cellColumnSubTitle.setCellValue("Encadrements");cellColumnSubTitle.setCellStyle(columnTitleStyle);
			sheet.setColumnWidth(3, 4000);
			
			cellColumnSubTitle = rowhead.createCell(4);
			cellColumnSubTitle.setCellValue("Expertises");cellColumnSubTitle.setCellStyle(columnTitleStyle);
			...
			for(int i=0; i<ess.size(); i++)
			{
				...
				sheetCell.setCellValue(ess.get(i).getNbrEncadrements());
				
				sheetCell = row.createCell(4);
				sheetCell.setCellValue(ess.get(i).getNbrExpertises());
