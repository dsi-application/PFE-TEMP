...
public class EtatExpertisesDetailedByYear_Excel
{
    ...
    public EtatExpertisesDetailedByYear_Excel(String selectedYear, List<EncadrementRSSStatusExcelDto> ess, String PSFile)
	{
		try
		{
